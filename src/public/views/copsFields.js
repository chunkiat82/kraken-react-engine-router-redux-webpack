            ...
            <Row className="show-grid">                
                <Col xs={12} md={12}>
                    <Panel header="Field">
                         <Row className="show-grid">                            
                            <Col xs={12} md={12}>
                                <Input type="select" label="Field Name" placeholder="select" name={this.props.key + '[fieldName]'}>
                        ...
                        <Row className="show-grid">
                            <Col xs={12} md={12}>
                                <Input type="select" label="Input type" placeholder="select" name={this.props.key + '[inputType]'}>
                        ...
                        <Row className="show-grid">
                            <Col xs={12} md={12}>
                                <Input type="select" label="constriant" placeholder="select" name={this.props.key + '[constraint]'}>
                        ...
                        <Row className="show-grid">
                            <Col xs={12} md={12}>
                                <Input type="select" label="Access Mode" placeholder="select" name={this.props.key + '[accessMode]'}>
